...
# Method taken from https://github.com/megvii-research/CREStereo/blob/ad3a1613bdedd88b93247e5f002cb7c80799762d/dataset.py
...
def readDispMiddlebury(file_name):
    if basename(file_name) == 'disp5.png':
        disp = np.array(read_gen(file_name)).astype(np.float32)
        valid = disp > 0
